...
public class GuiEvents
{
    ...
    // active = event.getGui() instanceof GuiWearables;
    // GuiContainer gui = (GuiContainer) event.getGui();
    // event.getButtonList().add(new GuiWearableButton(56, gui.guiLeft,
    // gui.guiTop, 26, 9, 10, 10,
    // I18n.format(active ? "button.wearables.off" : "button.wearables.on", new
    // Object[0])));
    // }
    // }
    //
    ...
    // @SideOnly(value = Side.CLIENT)
    // @SubscribeEvent
    // public void guiPostBaubles(GuiScreenEvent.ActionPerformedEvent.Post
    // event)
    // {
    // if (event.getGui() instanceof GuiPlayerExpanded)
    // {
    ...
    // ThutWearables.packetPipeline.sendToServer(packet);
    // active = !active;
    // event.getButton().displayString = I18n.format(active ?
    // "button.wearables.off" : "button.wearables.on",
    // new Object[0]);
    // }
    // }
    // }
    ...
    // @SideOnly(value = Side.CLIENT)
    // @SubscribeEvent
    // public void guiPostBaubles_old(GuiScreenEvent.ActionPerformedEvent.Post
    // event)
    // {
    // if (event.getGui() instanceof GuiPlayerExpanded)
    // {
